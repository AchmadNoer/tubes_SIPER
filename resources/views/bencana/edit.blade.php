...
@section('header')
	...
	<h2 align="center" style="padding: 20px 0px 20px 0px; font-family: Bahnschrift;">Edit Info Bencana</h2>
@stop
...
<div style="background-color: lightblue; padding: 7px;margin-bottom: 10px;">
	...
	{!! Form::model($bencana,['url'=>['bencana/list',$bencana->id_bencana], 'method'=>'patch', 'class'=>'form-horizontal']) !!}
		...
		<div class="form-group">
			...
			<div class="col-md-10">
				<textarea name="deskripsi" class="form-control" rows="8" maxlength="1000">{{$bencana->deskripsi}}</textarea>
