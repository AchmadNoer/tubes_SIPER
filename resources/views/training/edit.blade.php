...
@section('header')
	...
	<h2 align="center" style="padding: 20px 0px 20px 0px; font-family: Bahnschrift;">Edit Info Training</h2>
@stop
...
<div style="background-color: lightblue; padding: 7px;margin-bottom: 10px;">
	...
	{!! Form::model($training,['url'=>['training/list',$training->id_training], 'method'=>'patch', 'class'=>'form-horizontal']) !!}
		<div class="form-group">
			<label for="tgl_training" class="control-label col-md-2">Tanggal Training</label>
			<div class="col-md-10">
				{!! Form::date('tgl_training', null, ['class'=>'form-control']) !!}
